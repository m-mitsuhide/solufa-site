var Viewer = {
  ...
  view: function( a, data ) {
    ...
    return {tag: "div", attrs: {id: data.id, class: data.isMobile ? "mobile" : ""}, children: [
      {tag: "div", attrs: {class: "device" + ( vm.rotation ? " rotation" : "")}, children: [
        ...
        {tag: "div", attrs: {class: "viewer" + ( vm.isLandscape ? " landscape" : "")}, children: [
          {tag: "div", attrs: {id:"fsTarget"}, children: [
            ...
            {tag: "div", attrs: {class:"ctrls cs", onclick: full.exitFullscreen, style:{ display: full.isFull ? "block" : "none", bottom: "15px", right: "15px"}}, children: [{tag: "div", attrs: {}}]}
          ]}
        ]}
      ]}, 
      {tag: "div", attrs: {class:"ctrls rotate", style:{ display: data.isMobile ? "none" : "block", bottom: "2.5%", left: "4%"}, onclick: vm.rotate.bind( vm)}, children: [{tag: "div", attrs: {}}]}, 
      {tag: "div", attrs: {class:"ctrls share", style:{ top: "2.5%", left: "4%"}, onclick: vm.share.bind( vm)}, children: [{tag: "div", attrs: {}}]}, 
      {tag: "div", attrs: {class:"ctrls close", style:{ top: "2.5%", right: "4%"}, onclick: vm.close.bind( vm)}, children: [{tag: "div", attrs: {}}]}, 
      {tag: "div", attrs: {class:"ctrls fs", style:{ bottom: "2.5%", right: "4%"}, onclick: vm.fullscreen}, children: [{tag: "div", attrs: {}}]}
    ]};
  }
};
