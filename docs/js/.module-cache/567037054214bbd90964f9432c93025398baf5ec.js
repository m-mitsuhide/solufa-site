  ...
  vm: {
    ...
    init: function() {
      window.addEventListener( "message", function( e ) {
        ...
        var json = JSON.parse( e.data );console.log(json);
      }, false );
    },
    rotate: function() {
    ...
    send: function() {
      this.iframeWindow.postMessage( JSON.stringify({ value: this.value }), "*" );
    }
  },
  controller: function() {
    Viewer.vm.init();
      ...
      {tag: "div", attrs: {class: "device" + ( vm.rotation ? " rotation" : "")}, children: [
        ...
        {tag: "div", attrs: {class: "viewer" + ( vm.isLandscape ? " landscape" : "")}, children: [
          {tag: "div", attrs: {id:"fsTarget"}, children: [
            {tag: "iframe", attrs: {src: data.src, config: vm.getWindow.bind( vm), allowfullscreen:true,onload: vm.send.bind( this) }}, 
