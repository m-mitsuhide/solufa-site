var Viewer = {
  vm: {
    ...
    fullscreen: function() {full.isFull=true;
      ...
      {tag: "div", attrs: {class: "device" + ( vm.rotation ? " rotation" : "")}, children: [
        ...
        {tag: "div", attrs: {class: "viewer" + ( vm.isLandscape ? " landscape" : "")}, children: [
          {tag: "div", attrs: {id:"fsTarget"}, children: [
            ...
            {tag: "div", attrs: {class:"ctrls cs", onclick: full.exitFullscreen, style:{ display: full.isFull ? "block" : "block", bottom: "5px", right: "5px"}}}
          ]}
        ]}
      ]}, 
