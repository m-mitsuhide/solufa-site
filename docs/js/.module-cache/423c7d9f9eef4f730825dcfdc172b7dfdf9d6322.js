  ...
  view: function( a, data ) {
    ...
    return {tag: "div", attrs: {id: data.id}, children: [
      {tag: "div", attrs: {class:"btns"}, children: [
        {tag: "div", attrs: {class:"new", title:"Create new", onclick: data.oncreate}}, 
        ...
        {tag: "div", attrs: {class:"zoom-in", title:"Zoom in", onclick: vm.zoomIn.bind( vm) }}, 
        {tag: "div", attrs: {class:"zoom-out", title:"Zoom out", onclick: vm.zoomOut.bind( vm) }}
      ]}, 
