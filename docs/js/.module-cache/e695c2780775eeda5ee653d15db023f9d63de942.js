...
var App = {
  vm: {
    ...
    init: function() {
      window.addEventListener( "scroll", function() {
        this.backOpacity = Math.min( window.pageYOffset / window.innerHeight, 1 ) * .8;
        m.redraw();
      }.bind( this ), false );
    }
  },
  ...
  view: function() {
    ...
    return {tag: "div", attrs: {}, children: [
      ...
      {tag: "div", attrs: {id:"top", class:"white", style:{ opacity: 1.5 - vm.backOpacity * 1.5, height: window.innerHeight + "px"}}, children: [
