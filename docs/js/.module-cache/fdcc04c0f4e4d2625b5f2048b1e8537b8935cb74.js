var App = {
  ...
  view: function() {
    ...
    return {tag: "div", attrs: {id:"root", style: vm.isPortrait ? {} : { position: "fixed" }}, children: [
      ...
      {tag: "div", attrs: {class:"frame", style: vm.isPortrait ? { position: "relative", height: window.innerHeight + "px" } : { left: vm.baseLength + "px", right: 0 }}, children: [
        m.component(Editor, {id:"editor"})
      ]}
    ]};
  }
};
