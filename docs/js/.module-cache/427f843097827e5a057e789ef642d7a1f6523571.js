  ...
  view: function() {
    ...
    return {tag: "div", attrs: {}, children: [
      ...
      {tag: "div", attrs: {id:"top", class:"white", style:{ height: window.innerHeight + "px"}}, children: [
        ...
        SnsBtn, 
        {tag: "div", attrs: {class:"mithril"}, children: ["Made with", m.trust("&emsp;"), {tag: "a", attrs: {class:"italic", href:"http://mithril.js.org/", target:"_brank"}, children: [{tag: "span", attrs: {}, children: ["○"]}, " Mithril"]}]}
      ]}, 
...
最高のモバイル体験を提供。*/
      ...
      {tag: "div", attrs: {id:"usage"}, children: [
        {tag: "div", attrs: {id:"document"}, children: [
          {tag: "span", attrs: {class:"white italic"}, children: ["Document"]}, 
          {tag: "div", attrs: {}, children: [{tag: "a", attrs: {href:"document/"}, children: [{tag: "img", attrs: {src:"img/logo.png"}}]}]}, 
          {tag: "div", attrs: {class:"mithril"}, children: [{tag: "a", attrs: {class:"italic", href:"http://mithril.js.org/getting-started.html", target:"_brank"}, children: [{tag: "span", attrs: {}, children: ["○"]}, " Mithril"]}]}
        ]}
      ]}, 
      SnsScript
    ]};
