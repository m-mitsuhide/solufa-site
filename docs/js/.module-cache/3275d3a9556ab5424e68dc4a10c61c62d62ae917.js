var msx = require('../libs/MSXTransformer.js', function(a) {console.log(a)});
var Viewer = {
  vm: {
    rotation: false,
    isLandscape: false,
    ...
    send: function() {
      this.iframeWindow.postMessage( JSON.stringify({ scripts: this.scripts, value: msx.transform( this.value, {harmony: true}) }), "*" );
    }
  },
  controller: function() {
    Viewer.vm.init();
