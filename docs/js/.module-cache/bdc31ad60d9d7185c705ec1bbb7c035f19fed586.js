  ...
  view: function() {
    ...
    return {tag: "div", attrs: {id:"root", style: vm.isPortrait ? {} : { position: "fixed" }}, children: [
      {tag: "div", attrs: {class:"frame", style: vm.isPortrait ? { position: "relative", width: "100%", height: window.innerHeight + "px" } : { width: vm.baseLength + "px"}}, children: [
        ...
        {tag: "div", attrs: {class:"frame", style: vm.isPortrait ? { left: "50%", width: vm.baseLength + "px", height: vm.baseLength + "px", top: "auto", bottom: 0 } : { width: "100%", height: vm.baseLength + "px", top: "auto", bottom: 0 }, config: vm.updated.bind( vm) }, children: [
