...
var SnsBtn = {
  ...
  view: function() {
    return {tag: "div", attrs: {class:"sns"}, children: [
      {tag: "iframe", attrs: {src:"http://ghbtns.com/github-btn.html?user=amatelus&repo=solufa&type=watch&count=true", allowtransparency:"true", frameborder:"0", scrolling:"0", width:"80", height:"20"}}, 
      {tag: "div", attrs: {class:"fb-share-button", "data-href":"http://solufa.io/", "data-layout":"button_count"}}
    ]};
  }
};
