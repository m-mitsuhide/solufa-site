Solufa( function( m ) {
  ...
  var ThetaSphere = {
    ...
    view: function( ctrl, attrs, child ) {
      ...
      return {tag: "obj", attrs: {style:sphereStyle}, children: [{tag: "mesh", attrs: {geo: ctrl.geo, mtl: ctrl.mtl, id:attrs.id, class:attrs.class, castShadow:attrs.castShadow, receiveShadow:attrs.receiveShadow, style:attrs.style, config:setUv}, children: [
         child 
      ]}]};
    }
  };
